...
typedef struct giocatore{
    char *name;
    int point;             //Struttura per la gestione dei giocatori,nome_giocatore,puntenggio_giocatore,avversario per lo switch.
    int opponent;
}player;
...
extern int ATT_PLAYER = 0;  // Variabile esterna per controllare il turno di ogni giocatore.
